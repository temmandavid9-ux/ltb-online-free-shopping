...
export const watchProducts: Product[] = [
  {
    id: 'prod_watch_160',
    slug: 'ltb-precision-watch',
    name: 'LTB Precision Watch',
  ...
  {
    id: 'prod_watch_167',
    slug: 'ltb-black-horizon',
    name: 'LTB Black Horizon',
  ...
  {
    id: 'prod_watch_170',
    slug: 'ltb-business-master',
    name: 'LTB Business Master',
  ...
  {
    id: 'prod_watch_311',
    slug: 'ltb-sovereign-gold',
    name: 'LTB Sovereign Gold',
  ...
  {
    id: 'prod_watch_312',
    slug: 'ltb-titanium-pioneer',
    name: 'LTB Titanium Pioneer',

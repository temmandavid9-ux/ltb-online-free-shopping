export const es = {
  ...
  "account.tasksTitle": "Secuencia de Tareas Diarias",
  ...
  // Tasks Page
  "tasks.pageTitle": "Secuencia de Tareas Diarias",
  ...
  "tasks.allCompletedDescription": "PACK diario finalizado. Recompensa de $1.00 asegurada. Tareas bloqueadas por 24 horas.",
  ...
  "tasks.startButton": "Inicializar Tareas (Bono de $1)",

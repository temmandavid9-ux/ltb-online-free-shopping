          ...
          <div className="grid grid-cols-2 md:grid-cols-3 col-span-1 md:col-span-3 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="#" className="text-sm text-muted-foreground hover:text-primary">On Sale</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/account" className="text-sm text-muted-foreground hover:text-primary">Order Tracking</Link></li>
              </ul>
            </div>
            <div>

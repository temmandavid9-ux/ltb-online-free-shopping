...
import { Youtube, Instagram, Video, CheckCircle, Zap, Crown, Trophy, Lock, ExternalLink, ShieldCheck, Clock, PlayCircle } from 'lucide-react';
...
export default function TaskList() {
  ...
  const channels = [
    { id: 0, title: 'YouTube @LTBLIVESPORTSTV', icon: Youtube, url: 'https://www.youtube.com/@LTBLIVESPORTSTV/playlists', desc: `Stage 1 (+0.33)`, status: userData.step1Status },
    ...
    { id: 2, title: 'Kick: ltblivesports', icon: Video, url: 'https://kick.com/ltblivesports/videos/b4828303-1615-4c83-857c-2d94077b986c', desc: `Final Stage (+0.34)`, status: userData.step3Status }
  ];
